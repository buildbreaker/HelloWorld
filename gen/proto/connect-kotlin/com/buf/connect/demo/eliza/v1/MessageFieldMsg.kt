...
// Source: buf.connect.demo.eliza.v1.MessageFieldMsg in simple.proto
...
public class MessageFieldMsg(
  ...
  @field:WireField(
    tag = 1,
    adapter = "com.buf.connect.demo.eliza.v1.StringMsg#ADAPTER",
  )
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<MessageFieldMsg> = object : ProtoAdapter<MessageFieldMsg>(
      ...
      "type.googleapis.com/buf.connect.demo.eliza.v1.MessageFieldMsg", 
      PROTO_3, 
      null, 
      "simple.proto"
    ) {
