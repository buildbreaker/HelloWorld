...
// Source: google.protobuf.ExtensionRangeOptions in descriptor.proto
...
public class ExtensionRangeOptions(
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<ExtensionRangeOptions> = object :
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: ExtensionRangeOptions): Unit {
        writer.writeBytes(value.unknownFields)
        UninterpretedOption.ADAPTER.asRepeated().encodeWithTag(writer, 999,
            value.uninterpreted_option)
      }
      ...
      public override fun redact(`value`: ExtensionRangeOptions): ExtensionRangeOptions =
          value.copy(
