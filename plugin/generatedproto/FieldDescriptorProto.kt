...
// Source: google.protobuf.FieldDescriptorProto in descriptor.proto
...
public class FieldDescriptorProto(
  ...
  public val default_value: String? = null,
  /**
  ...
  public val oneof_index: Int? = null,
  /**
  ...
  public val json_name: String? = null,
  @field:WireField(
    tag = 8,
  ...
  public override fun hashCode(): Int {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (extendee?.hashCode() ?: 0)
      result = result * 37 + (default_value?.hashCode() ?: 0)
      result = result * 37 + (oneof_index?.hashCode() ?: 0)
      result = result * 37 + (json_name?.hashCode() ?: 0)
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<FieldDescriptorProto> = object :
        ProtoAdapter<FieldDescriptorProto>(
      ...
      public override fun encodedSize(`value`: FieldDescriptorProto): Int {
      ...
      public override fun encode(writer: ProtoWriter, `value`: FieldDescriptorProto): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: FieldDescriptorProto): Unit {
        writer.writeBytes(value.unknownFields)
        FieldOptions.ADAPTER.encodeWithTag(writer, 8, value.options)
        ProtoAdapter.STRING.encodeWithTag(writer, 10, value.json_name)
        ProtoAdapter.INT32.encodeWithTag(writer, 9, value.oneof_index)
      ...
      public override fun decode(reader: ProtoReader): FieldDescriptorProto {
      ...
      public override fun redact(`value`: FieldDescriptorProto): FieldDescriptorProto = value.copy(
  ...
  public enum class Label(
    ...
    public companion object {
      @JvmField
      public val ADAPTER: ProtoAdapter<Label> = object : EnumAdapter<Label>(
        Label::class, 
        PROTO_2, 
        null
      ) {
        public override fun fromValue(`value`: Int): Label? = Label.fromValue(value)
      }

      @JvmStatic
      public fun fromValue(`value`: Int): Label? = when (value) {
        1 -> LABEL_OPTIONAL
        2 -> LABEL_REQUIRED
        3 -> LABEL_REPEATED
        else -> null
