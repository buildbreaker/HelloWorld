...
// Source: google.protobuf.DescriptorProto in descriptor.proto
...
public class DescriptorProto(
  ...
  field_: List<FieldDescriptorProto> = emptyList(),
  ...
  public val field_: List<FieldDescriptorProto> = immutableCopyOf("field_", field_)
  ...
  public val nested_type: List<DescriptorProto> = immutableCopyOf("nested_type", nested_type)
  ...
  public val extension_range: List<ExtensionRange> = immutableCopyOf("extension_range",
      extension_range)
  ...
  public val oneof_decl: List<OneofDescriptorProto> = immutableCopyOf("oneof_decl", oneof_decl)
  ...
  public val reserved_range: List<ReservedRange> = immutableCopyOf("reserved_range", reserved_range)
  ...
  public override fun toString(): String {
    ...
    if (field_.isNotEmpty()) result += """field_=$field_"""
  ...
  public fun copy(
    ...
    field_: List<FieldDescriptorProto> = this.field_,
  ...
  ): DescriptorProto = DescriptorProto(name, field_, extension, nested_type, enum_type,
      extension_range, oneof_decl, options, reserved_range, reserved_name, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<DescriptorProto> = object : ProtoAdapter<DescriptorProto>(
      ...
      public override fun encodedSize(`value`: DescriptorProto): Int {
      ...
      public override fun encode(writer: ProtoWriter, `value`: DescriptorProto): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: DescriptorProto): Unit {
        writer.writeBytes(value.unknownFields)
        ProtoAdapter.STRING.asRepeated().encodeWithTag(writer, 10, value.reserved_name)
        ReservedRange.ADAPTER.asRepeated().encodeWithTag(writer, 9, value.reserved_range)
        MessageOptions.ADAPTER.encodeWithTag(writer, 7, value.options)
      ...
      public override fun decode(reader: ProtoReader): DescriptorProto {
      ...
      public override fun redact(`value`: DescriptorProto): DescriptorProto = value.copy(
        field_ = value.field_.redactElements(FieldDescriptorProto.ADAPTER),
  ...
  public class ExtensionRange(
    ...
    public companion object {
      @JvmField
      public val ADAPTER: ProtoAdapter<ExtensionRange> = object : ProtoAdapter<ExtensionRange>(
        FieldEncoding.LENGTH_DELIMITED, 
        ...
        public override fun encodedSize(`value`: ExtensionRange): Int {
          var size = value.unknownFields.size
        ...
        public override fun encode(writer: ProtoWriter, `value`: ExtensionRange): Unit {
        ...
        public override fun encode(writer: ReverseProtoWriter, `value`: ExtensionRange): Unit {
          writer.writeBytes(value.unknownFields)
          ExtensionRangeOptions.ADAPTER.encodeWithTag(writer, 3, value.options)
          ProtoAdapter.INT32.encodeWithTag(writer, 2, value.end)
          ProtoAdapter.INT32.encodeWithTag(writer, 1, value.start)
        ...
        public override fun decode(reader: ProtoReader): ExtensionRange {
          var start: Int? = null
          var end: Int? = null
        ...
        public override fun redact(`value`: ExtensionRange): ExtensionRange = value.copy(
  ...
  public class ReservedRange(
    ...
    public companion object {
      @JvmField
      public val ADAPTER: ProtoAdapter<ReservedRange> = object : ProtoAdapter<ReservedRange>(
        FieldEncoding.LENGTH_DELIMITED, 
        ReservedRange::class, 
        ...
        public override fun encodedSize(`value`: ReservedRange): Int {
          var size = value.unknownFields.size
          size += ProtoAdapter.INT32.encodedSizeWithTag(1, value.start)
          size += ProtoAdapter.INT32.encodedSizeWithTag(2, value.end)
          return size
        ...
        public override fun encode(writer: ProtoWriter, `value`: ReservedRange): Unit {
          ProtoAdapter.INT32.encodeWithTag(writer, 1, value.start)
          ProtoAdapter.INT32.encodeWithTag(writer, 2, value.end)
          writer.writeBytes(value.unknownFields)
        }

        public override fun encode(writer: ReverseProtoWriter, `value`: ReservedRange): Unit {
          writer.writeBytes(value.unknownFields)
          ProtoAdapter.INT32.encodeWithTag(writer, 2, value.end)
          ProtoAdapter.INT32.encodeWithTag(writer, 1, value.start)
        }

        public override fun decode(reader: ProtoReader): ReservedRange {
          var start: Int? = null
          var end: Int? = null
          val unknownFields = reader.forEachTag { tag ->
            when (tag) {
        ...
        public override fun redact(`value`: ReservedRange): ReservedRange = value.copy(
          unknownFields = ByteString.EMPTY
        )
      }
