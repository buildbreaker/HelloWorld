...
// Source: google.protobuf.UninterpretedOption in descriptor.proto
...
public class UninterpretedOption(
  ...
  public val identifier_value: String? = null,
  @field:WireField(
    tag = 4,
    adapter = "com.squareup.wire.ProtoAdapter#UINT64",
    jsonName = "positiveIntValue",
  )
  public val positive_int_value: Long? = null,
  @field:WireField(
    tag = 5,
    adapter = "com.squareup.wire.ProtoAdapter#INT64",
    jsonName = "negativeIntValue",
  )
  public val negative_int_value: Long? = null,
  @field:WireField(
    tag = 6,
  ...
  public val string_value: ByteString? = null,
  @field:WireField(
    tag = 8,
    adapter = "com.squareup.wire.ProtoAdapter#STRING",
    jsonName = "aggregateValue",
  )
  public val aggregate_value: String? = null,
  ...
  public val name: List<NamePart> = immutableCopyOf("name", name)
  ...
  public override fun hashCode(): Int {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (identifier_value?.hashCode() ?: 0)
      result = result * 37 + (positive_int_value?.hashCode() ?: 0)
      result = result * 37 + (negative_int_value?.hashCode() ?: 0)
      result = result * 37 + (double_value?.hashCode() ?: 0)
      result = result * 37 + (string_value?.hashCode() ?: 0)
      result = result * 37 + (aggregate_value?.hashCode() ?: 0)
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<UninterpretedOption> = object :
        ProtoAdapter<UninterpretedOption>(
      ...
      public override fun encodedSize(`value`: UninterpretedOption): Int {
      ...
      public override fun encode(writer: ProtoWriter, `value`: UninterpretedOption): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: UninterpretedOption): Unit {
        writer.writeBytes(value.unknownFields)
        ProtoAdapter.STRING.encodeWithTag(writer, 8, value.aggregate_value)
        ProtoAdapter.BYTES.encodeWithTag(writer, 7, value.string_value)
        ProtoAdapter.DOUBLE.encodeWithTag(writer, 6, value.double_value)
      ...
      public override fun decode(reader: ProtoReader): UninterpretedOption {
      ...
      public override fun redact(`value`: UninterpretedOption): UninterpretedOption = value.copy(
  ...
  public class NamePart(
    ...
    public val is_extension: Boolean,
    unknownFields: ByteString = ByteString.EMPTY,
    ...
    public companion object {
      @JvmField
      public val ADAPTER: ProtoAdapter<NamePart> = object : ProtoAdapter<NamePart>(
        FieldEncoding.LENGTH_DELIMITED, 
        NamePart::class, 
        ...
        public override fun encodedSize(`value`: NamePart): Int {
          var size = value.unknownFields.size
        ...
        public override fun encode(writer: ProtoWriter, `value`: NamePart): Unit {
          ProtoAdapter.STRING.encodeWithTag(writer, 1, value.name_part)
          ProtoAdapter.BOOL.encodeWithTag(writer, 2, value.is_extension)
          writer.writeBytes(value.unknownFields)
        }

        public override fun encode(writer: ReverseProtoWriter, `value`: NamePart): Unit {
          writer.writeBytes(value.unknownFields)
          ProtoAdapter.BOOL.encodeWithTag(writer, 2, value.is_extension)
          ProtoAdapter.STRING.encodeWithTag(writer, 1, value.name_part)
        }

        public override fun decode(reader: ProtoReader): NamePart {
        ...
        public override fun redact(`value`: NamePart): NamePart = value.copy(
          unknownFields = ByteString.EMPTY
        )
      }
