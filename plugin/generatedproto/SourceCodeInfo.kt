...
// Source: google.protobuf.SourceCodeInfo in descriptor.proto
...
public class SourceCodeInfo(
  ...
  public val location: List<Location> = immutableCopyOf("location", location)
  ...
  public fun copy(location: List<Location> = this.location, unknownFields: ByteString =
      this.unknownFields): SourceCodeInfo = SourceCodeInfo(location, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<SourceCodeInfo> = object : ProtoAdapter<SourceCodeInfo>(
      ...
      public override fun encodedSize(`value`: SourceCodeInfo): Int {
        var size = value.unknownFields.size
        size += Location.ADAPTER.asRepeated().encodedSizeWithTag(1, value.location)
        return size
      }

      public override fun encode(writer: ProtoWriter, `value`: SourceCodeInfo): Unit {
        Location.ADAPTER.asRepeated().encodeWithTag(writer, 1, value.location)
        writer.writeBytes(value.unknownFields)
      }

      public override fun encode(writer: ReverseProtoWriter, `value`: SourceCodeInfo): Unit {
        writer.writeBytes(value.unknownFields)
        Location.ADAPTER.asRepeated().encodeWithTag(writer, 1, value.location)
      }

      public override fun decode(reader: ProtoReader): SourceCodeInfo {
      ...
      public override fun redact(`value`: SourceCodeInfo): SourceCodeInfo = value.copy(
  ...
  public class Location(
    ...
    public val leading_comments: String? = null,
    @field:WireField(
      tag = 4,
      adapter = "com.squareup.wire.ProtoAdapter#STRING",
      jsonName = "trailingComments",
    )
    public val trailing_comments: String? = null,
    ...
    public val span: List<Int> = immutableCopyOf("span", span)
    ...
    public val leading_detached_comments: List<String> =
        immutableCopyOf("leading_detached_comments", leading_detached_comments)
    ...
    public override fun hashCode(): Int {
      ...
      if (result == 0) {
        ...
        result = result * 37 + (leading_comments?.hashCode() ?: 0)
        result = result * 37 + (trailing_comments?.hashCode() ?: 0)
    ...
    public companion object {
      ...
      public val ADAPTER: ProtoAdapter<Location> = object : ProtoAdapter<Location>(
        ...
        public override fun encode(writer: ProtoWriter, `value`: Location): Unit {
        ...
        public override fun encode(writer: ReverseProtoWriter, `value`: Location): Unit {
          writer.writeBytes(value.unknownFields)
          ProtoAdapter.STRING.asRepeated().encodeWithTag(writer, 6, value.leading_detached_comments)
          ProtoAdapter.STRING.encodeWithTag(writer, 4, value.trailing_comments)
          ProtoAdapter.STRING.encodeWithTag(writer, 3, value.leading_comments)
