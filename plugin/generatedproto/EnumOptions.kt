...
// Source: google.protobuf.EnumOptions in descriptor.proto
...
public class EnumOptions(
  ...
  public val allow_alias: Boolean? = null,
  /**
  ...
  public override fun hashCode(): Int {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (allow_alias?.hashCode() ?: 0)
  ...
  public companion object {
    ...
    @JvmField
    public val ADAPTER: ProtoAdapter<EnumOptions> = object : ProtoAdapter<EnumOptions>(
      ...
      public override fun encodedSize(`value`: EnumOptions): Int {
      ...
      public override fun encode(writer: ProtoWriter, `value`: EnumOptions): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: EnumOptions): Unit {
        writer.writeBytes(value.unknownFields)
        UninterpretedOption.ADAPTER.asRepeated().encodeWithTag(writer, 999,
            value.uninterpreted_option)
        ProtoAdapter.BOOL.encodeWithTag(writer, 3, value.deprecated)
      ...
      public override fun decode(reader: ProtoReader): EnumOptions {
      ...
      public override fun redact(`value`: EnumOptions): EnumOptions = value.copy(
