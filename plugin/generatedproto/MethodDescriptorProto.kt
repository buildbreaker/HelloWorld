...
// Source: google.protobuf.MethodDescriptorProto in descriptor.proto
...
public class MethodDescriptorProto(
  ...
  public val input_type: String? = null,
  @field:WireField(
    tag = 3,
    adapter = "com.squareup.wire.ProtoAdapter#STRING",
    jsonName = "outputType",
  )
  public val output_type: String? = null,
  @field:WireField(
    tag = 4,
  ...
  public val client_streaming: Boolean? = null,
  /**
  ...
  public val server_streaming: Boolean? = null,
  ...
  public override fun hashCode(): Int {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (input_type?.hashCode() ?: 0)
      result = result * 37 + (output_type?.hashCode() ?: 0)
      result = result * 37 + (options?.hashCode() ?: 0)
      result = result * 37 + (client_streaming?.hashCode() ?: 0)
      result = result * 37 + (server_streaming?.hashCode() ?: 0)
  ...
  public companion object {
    public const val DEFAULT_CLIENT_STREAMING: Boolean = false

    public const val DEFAULT_SERVER_STREAMING: Boolean = false

    @JvmField
    public val ADAPTER: ProtoAdapter<MethodDescriptorProto> = object :
        ProtoAdapter<MethodDescriptorProto>(
      ...
      public override fun encodedSize(`value`: MethodDescriptorProto): Int {
      ...
      public override fun encode(writer: ProtoWriter, `value`: MethodDescriptorProto): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: MethodDescriptorProto): Unit {
        writer.writeBytes(value.unknownFields)
        ProtoAdapter.BOOL.encodeWithTag(writer, 6, value.server_streaming)
        ProtoAdapter.BOOL.encodeWithTag(writer, 5, value.client_streaming)
        MethodOptions.ADAPTER.encodeWithTag(writer, 4, value.options)
      ...
      public override fun decode(reader: ProtoReader): MethodDescriptorProto {
      ...
      public override fun redact(`value`: MethodDescriptorProto): MethodDescriptorProto =
          value.copy(
